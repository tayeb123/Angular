...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>view-users works!</p>\n");
...
class User {
    constructor(username, password, firstName, lastName, email, role) {
...
let UserService = class UserService {
    ...
    getAllUsers() {
        ...
        return this.httpc.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBackend}users`)
    ...
    addUser(user) {
        return this.httpc.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBackend}users`, user);
    }
    findById(id) {
        return this.httpc.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBackend}users/${id}`);
    }
    editById(id, user) {
        return this.httpc.patch(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBackend}users/${id}`, user);
    }
    delete(id) {
        return this.httpc.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urlBackend}users/${id}`);
    }
};
...
let AddUsersComponent = class AddUsersComponent {
    constructor(userService, location, router, activatedRoute) {
...
AddUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-users.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/user/add-users/add-users.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-users.component.scss */ "./src/app/modules/user/add-users/add-users.component.scss")).default]
    })
], AddUsersComponent);
...
let ListUsersComponent = class ListUsersComponent {
    ...
    ngOnInit() {
        this.userSerivce.getAllUsers().subscribe((users) => { this.users = users, this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.users); });
...
ListUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list-users.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/user/list-users/list-users.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list-users.component.scss */ "./src/app/modules/user/list-users/list-users.component.scss")).default]
    })
], ListUsersComponent);
...
/* harmony import */ var _list_users_list_users_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list-users/list-users.component */ "./src/app/modules/user/list-users/list-users.component.ts");
/* harmony import */ var _add_users_add_users_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./add-users/add-users.component */ "./src/app/modules/user/add-users/add-users.component.ts");
/* harmony import */ var _view_users_view_users_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view-users/view-users.component */ "./src/app/modules/user/view-users/view-users.component.ts");
...
const routes = [{ path: '', component: _user_component__WEBPACK_IMPORTED_MODULE_3__["UserComponent"] },
    { path: 'list', component: _list_users_list_users_component__WEBPACK_IMPORTED_MODULE_4__["ListUsersComponent"] },
    { path: 'add', component: _add_users_add_users_component__WEBPACK_IMPORTED_MODULE_5__["AddUsersComponent"] },
    { path: 'view/:id', component: _view_users_view_users_component__WEBPACK_IMPORTED_MODULE_6__["ViewUsersComponent"] }];
...
/* harmony import */ var _user_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./user.component */ "./src/app/modules/user/user.component.ts");
/* harmony import */ var _list_users_list_users_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./list-users/list-users.component */ "./src/app/modules/user/list-users/list-users.component.ts");
/* harmony import */ var _add_users_add_users_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-users/add-users.component */ "./src/app/modules/user/add-users/add-users.component.ts");
/* harmony import */ var _view_users_view_users_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view-users/view-users.component */ "./src/app/modules/user/view-users/view-users.component.ts");
...
ViewUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./view-users.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/user/view-users/view-users.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./view-users.component.scss */ "./src/app/modules/user/view-users/view-users.component.scss")).default]
    })
], ViewUsersComponent);
